...
tau_eqn2 = H22*ddtheta2 + H12*ddtheta1 + h*dtheta1^2 + G1 == tau2 + tau_a(2);
...
% 
% tau1Eq = g*((1/2)*m1 + m2)*l1*cos(theta1) + (1/2)*m2*l2*cos(theta1 + theta2);
% tau2Eq = g*((1/2)*m2*l2*cos(theta1+theta2));
